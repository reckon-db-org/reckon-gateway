...
%%%   GET  /v1/stores/:store_id/dcb/payload-indexes  CCC declared index discovery
...
child_spec() ->
    ...
    Routes = cowboy_router:compile([
        {'_', [
            ...
            {"/v1/stores/:store_id/dcb/payload-indexes",
             reckon_gateway_http_dcb, #{op => payload_indexes}},
